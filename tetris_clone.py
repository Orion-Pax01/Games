...
# --- Shapes ---
# Shape formats for the Tetrominoes
S = [['.....',
      '.....',
      '..00.',
      '.00..',
...
def create_grid(locked_positions={}):
    ...
    Grid is a 2D list of colors, initialized to black (0,0,0).
    """
...
def convert_shape_format(piece):
    """
    Converts the shape format into a list of block positions.
    """
    positions = []
    ...
    # Offset positions to be relative to the piece's center
...
def valid_space(piece, grid):
    ...
    """
    # Create a 2D list of accepted positions (empty cells)
...
def check_lost(positions):
    """
    Checks if any locked block is above the top of the screen.
    """
...
def clear_rows(grid, locked):
    """
    Clears completed rows and shifts the above rows down.
    ...
    if increment > 0:
        # Sort locked positions by y-value
...
def draw_next_shape(piece, surface):
    """
    Draws the 'Next Piece' preview on the screen.
    """
...
def draw_window(surface, grid, score=0):
    """
    Draws all elements on the main game window.
    """
...
def main(win):
    ...
    while run:
        ...
        # Color the grid for the current piece
